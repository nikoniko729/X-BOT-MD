...
const ALIVE = process.env.ALIVE || "HELLOW IAM ALIVE NOW PLEASE GET MENU 🔮";
const HANDLERS = process.env.HANDLER || "^";
const SESSION_ID = process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:aedb1787b5a44b18953e30051903a72a";
